...
class Reaction(Base):
    ...
    artist_emojis = relationship(
        "ArtistReactionEmoji", back_populates="reaction", cascade="all, delete-orphan"
    )
    artist_messages = relationship(
        "ArtistReactionMessage", back_populates="reaction", cascade="all, delete-orphan"
    )
    notifications = relationship(
        "Notification", back_populates="reaction", cascade="all, delete-orphan"
    )
