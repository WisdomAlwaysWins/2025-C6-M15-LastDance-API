...
class Notification(Base):
    ...
    artist_id = Column(
        Integer, ForeignKey("artists.id", ondelete="CASCADE"), nullable=True, index=True
    )
    ...
    exhibition_id = Column(
        Integer, ForeignKey("exhibitions.id", ondelete="CASCADE"), nullable=True
    )
    artwork_id = Column(
        Integer, ForeignKey("artworks.id", ondelete="CASCADE"), nullable=True
    )
    visit_history_id = Column(
        Integer, ForeignKey("visit_histories.id", ondelete="CASCADE"), nullable=True
    )
    ...
    def __repr__(self):
        user_info = (
            ...
            if self.visitor_id
            else f"artist_id={self.artist_id}"
        )
